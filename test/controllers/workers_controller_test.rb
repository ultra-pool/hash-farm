...
class WorkersControllerTest < ActionController::TestCase
  ...
  test "should create worker" do
    assert_difference('Worker.count') do
      post :create, worker: { is_anonymous: @worker.is_anonymous, name: @worker.name, user_id: @worker.user_id }
    end
  ...
  test "should update worker" do
    patch :update, id: @worker, worker: { is_anonymous: @worker.is_anonymous, name: @worker.name, user_id: @worker.user_id }
    assert_redirected_to worker_path(assigns(:worker))
  end
